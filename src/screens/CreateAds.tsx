...
import { HStack, ScrollView, VStack, Text, useToast, Icon, Stack, TextArea } from "native-base";
...
return(
    <ScrollView paddingTop={10} pl={8}>
        ...
        <Text mt={8} fontFamily="heading" color="gray.100" fontSize={16}>Sobre o Produto</Text>
